          ...
          <div className="relative mx-auto grid max-w-2xl grid-cols-1 gap-x-10 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
            ...
            <div className="flex flex-wrap items-start justify-end gap-6 sm:gap-8 lg:contents">
              <div className="w-0 flex-auto lg:ml-auto lg:w-auto lg:flex-none lg:self-end">
                <Image src="https://firebasestorage.googleapis.com/v0/b/nuxtsah.appspot.com/o/art%2FIoNSbx0PCwqMswiCK8IT_0.JPG?alt=media" alt="" width={1200} height={1200} className="aspect-[7/5] w-[37rem] max-w-none rounded-2xl bg-gray-50 object-cover" />
              </div>
              <div className="contents lg:col-span-2 lg:col-end-2 lg:ml-auto lg:flex lg:w-[37rem] lg:items-start lg:justify-end lg:gap-x-8">
                <div className="order-first flex w-64 flex-none justify-end self-end lg:w-auto">
                  <Image src="https://firebasestorage.googleapis.com/v0/b/nuxtsah.appspot.com/o/art%2FV58A1TWc69lAO97VjDdJ_0.JPG?alt=media" alt="" width={1200} height={1200} className="aspect-[4/3] w-[24rem] max-w-none flex-none rounded-2xl bg-gray-50 object-cover" />
                </div>
                <div className="flex w-96 flex-auto justify-end lg:w-auto lg:flex-none">
                  <Image src="https://firebasestorage.googleapis.com/v0/b/nuxtsah.appspot.com/o/art%2FQ4eIXpUvPL7iq429qHC1_0.JPG?alt=media" alt="" width={1200} height={1200} className="aspect-[7/5] w-[37rem] max-w-none flex-none rounded-2xl bg-gray-50 object-cover" />
                </div>
                <div className="hidden sm:block sm:w-0 sm:flex-auto lg:w-auto lg:flex-none">
                  <Image src="https://firebasestorage.googleapis.com/v0/b/nuxtsah.appspot.com/o/art%2Fjacl3gl1fz0BOtWOXRbO_0.JPG?alt=media" alt="" width={1200} height={1200} className="aspect-[4/3] w-[24rem] max-w-none rounded-2xl bg-gray-50 object-cover" />
                </div>
              </div>
            </div>
          </div>
