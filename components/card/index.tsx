...
export default function Card({ id, title, image, description, count, type, source, index, cover }: any) {
            ...
            {cover ? (
                <article className={`group relative `}>
                    <div className="group relative">
                        <div className={`relative overflow-hidden rounded-lg bg-gray-200 group-hover:opacity-75`} style={{ paddingBottom: `${(cover[0].height / cover[0].width) * 100}%` }}>
