    ...
    return (
        <div className="grid grid-cols-4 items-center gap-4 md:gap-6">
            <div className="overflow-hidden rounded-xl bg-white shadow-2xl shadow-black/10 ">
                <MyImage src="https://firebasestorage.googleapis.com/v0/b/***REMOVED***.appspot.com/o/art%2F01h0FCbKPJLhJsPIRE5x_0.JPG?alt=media&token=e5b95880-9544-4d44-9a1a-227e8866e2dd&_gl=1*1n305tt*_ga*MTMyMzA0OTg0MS4xNjk0NTg4MTIw*_ga_CW55HF8NVT*MTY5NzIwODQ4NS40OS4xLjE2OTcyMDg1NDAuNS4wLjA." alt="Image 1" speed={30} />
            </div>
